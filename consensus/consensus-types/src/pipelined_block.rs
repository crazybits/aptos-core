...
use aptos_types::{
    ...
    transaction::{BlockEndInfo, SignedTransaction, TransactionStatus},
...
impl Serialize for PipelinedBlock {
        ...
        S: Serializer,
    {
        ...
        struct SerializedBlock<'a> {
            ...
            _deprecated: _DeprecatedStateComputeResult,
        ...
        let serialized = SerializedBlock {
            ...
            _deprecated: _DeprecatedStateComputeResult::dummy(),
...
pub struct _DeprecatedStateComputeResult {
    _root_hash: HashValue,
    _frozen_subtree_roots: Vec<HashValue>,
    _parent_frozen_subtree_roots: Vec<HashValue>,
    _num_leaves: u64,
    _parent_num_leaves: u64,
    _epoch_state: Option<EpochState>,
    _compute_status_for_input_txns: Vec<TransactionStatus>,
    _transaction_info_hashes: Vec<HashValue>,
    _subscribable_events: Vec<ContractEvent>,
    _block_end_info: Option<BlockEndInfo>,
}

impl _DeprecatedStateComputeResult {
    fn dummy() -> Self {
        Self {
            _root_hash: HashValue::zero(),
            _frozen_subtree_roots: vec![],
            _parent_frozen_subtree_roots: vec![],
            _num_leaves: 0,
            _parent_num_leaves: 0,
            _epoch_state: None,
            _compute_status_for_input_txns: vec![],
            _transaction_info_hashes: vec![],
            _subscribable_events: vec![],
            _block_end_info: None,
        }
    }
}
